...
const Navbar = () => {
  return (
    <header className="w-full flex items-center pad-x relative">
      <nav className="flex w-full items-center py-6 gap-x-8 md:px-8">
        {/* Logo */}
        <div className="w-fit flex items-start md:items-center gap-x-1 group peer cursor-pointer">
          <h1 className="text-xl md:text-2xl uppercase z-10 bg-foreground leading-none md:leading-normal">
            Pixel
          </h1>
